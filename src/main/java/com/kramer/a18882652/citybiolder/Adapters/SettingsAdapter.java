...
public class SettingsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
    ...
    /*
    * Create a viewholder depending on the type
    * types are retrived from getItemViewType method
    * String, Float, Interger UI
    * The purpose was to set different constrains for each input of a type.
    * Do not want users entering letters as strings where interger is expected.
    *
    * There is also The save type which is a view for the save button.
    *
    *
    *
    * */
...
/* binding view holders based on type --explaintion above*/
    @Override
