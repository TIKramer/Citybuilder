...
public class StructureAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
    ...
    public class SettingStringVHolder extends RecyclerView.ViewHolder
    {
        ...
        {
            StructureAdapter2.this.updateSetting(this.getAdapterPosition(), settingValue.getText());
        }
    ...
    public StructureAdapter2(Activity activity, Map<String, Setting> settings)
    {
